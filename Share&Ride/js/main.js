...
$(window).load(function(){
    ...
    var myOptions = {
        zoom: 14,
        center: new google.maps.LatLng(23.815152, 90.425517), //change the coordinates
    ...
    marker = new google.maps.Marker({
        map: map,
        position: new google.maps.LatLng(23.815152, 90.425517) //change the coordinates
    });
    infowindow = new google.maps.InfoWindow({
        content: "<b>North South University</b>Dhaka<br/>Bangladesh"  //add your address
    });
